...
public class GotoPermissionPageUtils {
    ...
    //自己的项目包名
    private String packageName = Constants.Companion.getAPPLICATION_ID();
...
//        LL.e("PermissionPageManager", "resolveinfoList" + resolveinfoList.size());
//        for (int i = 0; i < resolveinfoList.size(); i++) {
//            LL.e("PermissionPageManager", resolveinfoList.get(i).activityInfo.packageName + resolveinfoList.get(i).activityInfo.name);
//        }
