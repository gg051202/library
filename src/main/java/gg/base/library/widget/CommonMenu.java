...
//        1     2                          3     4
//     【   图片   文字                 文字   图片   】
        int dp13 = AutoSizeUtils.dp2px(context, 13);
        int dp5 = AutoSizeUtils.dp2px(context, 5);
        ...
        //配置左边图片
        int dp20 = AutoSizeUtils.dp2px(context, 20);
        ...
        int dp15 = AutoSizeUtils.dp2px(context, 15);
